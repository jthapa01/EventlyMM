...
public class ApplicationTests : BaseTest
{
    ...
    [Fact]
    public void Command_ShouldHave_Command_As_Suffix()
    {
        Types.InAssembly(ApplicationAssembly)
            .That()
            .ImplementInterface(typeof(ICommand))
    ...
    [Fact]
    public void CommandHandler_ShouldHave_CommandHandler_As_Suffix()
    {
        Types.InAssembly(ApplicationAssembly)
            .That()
            .ImplementInterface(typeof(ICommandHandler<>))
    ...
    [Fact]
    public void Query_ShouldHave_Query_As_Suffix()
    {
        Types.InAssembly(ApplicationAssembly)
            .That()
            .ImplementInterface(typeof(IQuery<>))
    ...
    [Fact]
    public void QueryHandler_ShouldHave_QueryHandler_As_Suffix()
    {
        Types.InAssembly(ApplicationAssembly)
            .That()
            .ImplementInterface(typeof(IQueryHandler<,>))
    ...
    [Fact]
    public void Validator_ShouldHave_Validator_As_Suffix()
    {
        Types.InAssembly(ApplicationAssembly)
            .That()
            .Inherit(typeof(AbstractValidator<>))
    ...
    [Fact]
    public void DomainEventHandler_ShouldHave_DomainEventHandler_As_Suffix()
    {
        Types.InAssembly(ApplicationAssembly)
            .That()
            .ImplementInterface(typeof(IDomainEventHandler<>))
