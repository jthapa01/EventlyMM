...
internal static class CommandHelpers
{
    ...
    internal static async Task<Guid> CreateEventAsync(this ISender sender, Guid categoryId, DateTime? startsAtUtc = null)
    {
        var faker = new Faker();
        Result<Guid> result = await sender.Send(
            new CreateEventCommand(
                ...
                startsAtUtc ?? DateTime.UtcNow.AddMinutes(15), 
                null));
        return result.Value;
    }
